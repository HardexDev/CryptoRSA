 ...
 * @author jules
 */
public class Decalage implements Challenge {
    ...
    public void executeChallenge() throws IOException {
        ...
        do {
            NombreBinaire nb = new NombreBinaire(message1);
            int decalage = Integer.parseInt(message2);
            
            client.sendMessage(nb.decalage(decalage).toString());
